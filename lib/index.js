...
var Migrations = /** @class */ (function () {
    ...
    Migrations._getExecutedVersions = function () {
        return __awaiter(this, void 0, void 0, function () {
            var executedScripts;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    Migrations._findVersionsToExecute = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this._getExecutedVersions()];
                    case 1:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this._findVersionsToExecute()];
                    case 2:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.migrate(this._findIndexByVersion(versions[0]), rerun)];
                    case 1:
                        _a.sent();
                        return [3 /*break*/, 8];
                    case 2:
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, this.migrate(this._findIndexByVersion(version))];
                    case 4:
                        _a.sent();
                        _a.label = 5;
                    case 5:
    ...
    Migrations.migrate = function (index, rerun) {
        if (rerun === void 0) { rerun = false; }
        return __awaiter(this, void 0, void 0, function () {
            function scriptName() {
